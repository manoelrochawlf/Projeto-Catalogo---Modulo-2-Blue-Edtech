...
var pokedexArr = pokedex.pokemon

app.set("view engine", "ejs");
app.use(express.static(path.join(__dirname, 'public')));

app.get('/', (req, res) => {
  res.render('index', {pokedexArr});
})
app.get('/detalhes/:id', (req, res) => {
  var nowPoke = pokedexArr.filter((pokemon)=> pokemon.id == req.params.id)
  res.render("detalhes.ejs", {nowPoke});
})

app.listen(3000, () => console.log("Servidor rodando em http://localhost:300"));